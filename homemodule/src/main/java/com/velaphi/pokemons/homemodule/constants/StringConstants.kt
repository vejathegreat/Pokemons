package com.velaphi.pokemons.homemodule.constants

/**
 * Constants for hardcoded strings used throughout the homemodule
 */
object StringConstants {
    ...
    const val EMOJI_SERVER = "☁️"
    const val EMOJI_NETWORK = "📡"
